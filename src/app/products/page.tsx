...
export default async function ProductsPage() {
  ...
  return (
    <main className="bg-white">
      ...
      {/* FIX: Why This Model Works Section
        - Changed bg-gray-50 to bg-primary
        - Updated all text colors to white/gray-300
        - Made headlines text-accent (bright green)
      */}
      <div className="bg-primary py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-4xl text-center">
            ...
            <p className="mt-6 text-2xl font-semibold leading-8 text-accent">
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="flex flex-col rounded-2xl bg-white/5 p-8 shadow-lg ring-1 ring-white/10">
